		...
		<form id="frm" >
	  	...
	  	<tr align="center">
	  	 <td colspan="3" height="100" align="center">
	  	  <select  name="key" id="key">
	  		...
	  		<option value="id"      <%=pageBean.getKey("ename")%> >이름</option>
	  		<option value="title"   <%=pageBean.getKey("position")%>  >직위</option>
	  		<option value="contents" <%=pageBean.getKey("address")%>  >주소</option>
	  	  </select>
	  	...
	  	<tr align="center">
	  	  ...
	  	  <tr>
			 ...
			 <td><a href="#" onclick="getBoard(${employee.empno})"> ${employee.ename}</a></td>  	  
