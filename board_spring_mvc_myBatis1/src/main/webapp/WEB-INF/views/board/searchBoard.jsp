	 	...
	 	<form id="frm"  >
			...
			<table border="1" align="center">
				<tbody>
					...
					<c:if test="${!empth board.files }">
					<tr><td>업로드한 파일</td>
						<td>
							<c:forEach var="file" items="${board.files}">
								<a href="filedown.do?sfilename=${file.fileName}">${file.rfileName}</a> 
							</c:forEach>
						</td>
					</c:if>
				...
				<tfoot>
					<tr><td colspan="2" align="center">
						...
						<c:if test="${board.id == id }">
							...
							<a href="#" onclick="deleteBoard(${board.no})">삭제</a>
						</c:if>
						</td>
					</tr>
				</tfoot>
	 	...
	 	<form  id="updatefrm">
			...
			<table border="1" align="center">
				...
				<tbody>
					...
					<tr><td colspan="2">
						<textarea name="contents" id="contents" cols="30" rows="10">${board.contents}</textarea>
						</td></tr>
				</tbody>
				<tfoot>
					<tr><td colspan="2" align="center">
